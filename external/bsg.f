CC ----------------------------------------------------------------------------
CC  !last changes: jlk 07/03/2004 
C ------------------------------------------------------------------------------
...
C      our ew corrections are implemented only for mh=100 7/2000
        ...
        subroutine bsg(as,t,bc,rcb,aeinv,scw,scb,scl,vkm,bsl,deltp,io,
...
C       xstop       sbottom mixing angle (in units of PI)
...
C*************************************************************************
        ...
        cst= dcos(pi*xstopc) 
c  here we set Ad= At
c        tlr =sst*cst*(stophc**2-stoplc**2)
c        aad= tlr/tc + amuc/tb
c    CALL AD and set aad=ad

...
C
      IMPLICIT REAL*8(A-Z)
      COMPLEX*16 C0, C1P,C1M,C20,C2P,C2M,CSCAL,
     &           C1,C2
c     &           B0S12,B031,B032,B132,B131,B1S12,C1,C2
      XMF=MF*MF
...
c       PAUSE 'RTSEC EXCEED MAXIMUM ITERATIONS'
       endif
       END
c=====================================================================
c
...
C-----xyB0(K^2,M1,M2)---------------------------------------
      ...
      IMPLICIT NONE
      COMPLEX*16 THETHA
c      COMPLEX*16 B0B0,B1B1,THETHA
      DOUBLE PRECISION K2,M1,M2,M12,M22,EE,mm1,mm2,B0B0,B1B1
